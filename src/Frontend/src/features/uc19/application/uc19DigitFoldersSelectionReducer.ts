import type {
  Uc19DigitFoldersSelectionAction,
  Uc19DigitFoldersSelectionState,
} from "./uc19DigitFoldersSelectionTypes";

export function uc19DigitFoldersSelectionReducer(
  state: Uc19DigitFoldersSelectionState,
  action: Uc19DigitFoldersSelectionAction
): Uc19DigitFoldersSelectionState {
  switch (action.type) {
    case "stateReset":
      return {
