...
class ExperimentConfig:
    ...
    cell_grid_size: int = 9
    cell_inner_margin_ratio: float = 0.08
    cell_output_size: int = 64
    cell_contrast_clip_limit: float = 2.5
    cell_contrast_tile_grid_size: int = 8
    cell_threshold_block_size: int = 11
    cell_threshold_c: int = 2
    cell_border_clearance_px: int = 0
    cell_min_component_area_ratio: float = 0.0
    cell_contact_sheet_gap_px: int = 3
