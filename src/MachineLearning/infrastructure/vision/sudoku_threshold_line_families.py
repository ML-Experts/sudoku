...
from infrastructure.vision.sudoku_threshold_geometry import angle_difference_degrees
from infrastructure.vision.sudoku_threshold_models import DetectedLineSegment
...
def refine_family_angle_degrees(
    ...
    return float((np.degrees(np.arctan2(sin_sum, cos_sum)) / 2.0) % 180.0)
